...
export const consumptionApi = {
  ...
  matchChannels: () =>
    client.get<any>('/v1/consumption/matches/channels'),
  match: (id: number) =>
...
export const adminApi = {
  ...
  testSystemRuntimeWebhook: () => client.post<any>('/v1/admin/config/system-runtime-webhook/test'),
  ...
  discoverNvrVideoSource: (data: Record<string, any>) => client.post<any>('/v1/admin/video-sources/nvr/discover', data),
