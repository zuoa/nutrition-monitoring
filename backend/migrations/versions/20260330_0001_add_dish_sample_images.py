...
def upgrade():
    ...
    create_index_if_not_exists(op.f("ix_dish_sample_images_dish_id"), "dish_sample_images", ["dish_id"], unique=False)
...
def downgrade():
    drop_index_if_exists(op.f("ix_dish_sample_images_embedding_status"), table_name="dish_sample_images")
    drop_index_if_exists(op.f("ix_dish_sample_images_dish_id"), table_name="dish_sample_images")
    drop_table_if_exists("dish_sample_images")
