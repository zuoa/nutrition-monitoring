...
class Config:
    ...
    LOCAL_DINOV3_MODEL_PATH = os.environ.get("LOCAL_DINOV3_MODEL_PATH", "/data/models/vit-base-patch16-dinov3-lvd1689m")
    ...
    LOCAL_EMBEDDING_DISH_AGGREGATION_MAX_SAMPLES = max(
        1,
        _load_int_env("LOCAL_EMBEDDING_DISH_AGGREGATION_MAX_SAMPLES", 3),
    )
    LOCAL_EMBEDDING_DISH_MAX_WEIGHT = max(
        0.0,
        min(1.0, _load_float_env("LOCAL_EMBEDDING_DISH_MAX_WEIGHT", 0.7)),
    )
    ...
    DISH_CONFUSION_HIGH_THRESHOLD = _load_float_env("DISH_CONFUSION_HIGH_THRESHOLD", 0.85)
    DISH_CONFUSION_MEDIUM_THRESHOLD = _load_float_env("DISH_CONFUSION_MEDIUM_THRESHOLD", 0.75)
    DISH_CONFUSION_MAX_PAIRS = _load_int_env("DISH_CONFUSION_MAX_PAIRS", 100)
